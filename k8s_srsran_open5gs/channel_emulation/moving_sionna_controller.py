...
def parse_args():
    ...
    parser.add_argument(
        "--trajectory",
        default=str(REPO_ROOT / "channel_emulation/trajectories/short_straight_line.json"),
    )
    parser.add_argument(
        "--scene-config",
        default=str(REPO_ROOT / "channel_emulation/scenes/stationary_reflector.json"),
    )
    parser.add_argument(
        "--gnb-config",
